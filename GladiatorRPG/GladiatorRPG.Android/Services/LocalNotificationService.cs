...
using GladiatorRPG.Interfaces;
using System.Collections.Generic;
using System.Runtime.CompilerServices;
using Xamarin.Forms;
using AndroidApp = Android.App.Application;
//[assembly: Dependency(typeof(GladiatorRPG.Droid.Services.LocalNotificationsService))]
namespace GladiatorRPG.Droid.Services
{
    internal class LocalNotificationsService : ILocalNotificationsService
    {

        private const string CHANNEL_ID = "local_notifications_channel";
        private const string CHANNEL_NAME = "Notification";
        private const string CHANNEL_DESCRIPTION = "Local and push notifications message appear in this channel";
        ...
        public void ShowNotification(string title, string message, IDictionary<string,string> data)
        {
            ...
            var notificationBuilder = new NotificationCompat.Builder(AndroidApp.Context, CHANNEL_ID)
                .SetLargeIcon(BitmapFactory.DecodeResource(AndroidApp.Context.Resources, Resource.Mipmap.game_icon))
